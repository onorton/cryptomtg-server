"""
Django settings for cryptomtg_server project.
...
SECRET_KEY = '#nzxtm(*du_zxyu4)@5)jm&bbxkxu6i9hf5ul06m$&wwtmihdx'
...
WSGI_APPLICATION = 'cryptomtg_server.wsgi.application'
